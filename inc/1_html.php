<?php include('nav.php') ?>
    ...
    <div class="single-course-intro d-flex align-items-center justify-content-center" style="background-image: url(../img/bg-img/bg_h.jpg);">
        <!-- Content -->
                                ...
                                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab--1">
                                    <div class="clever-description">
                                        ...
                                        <div class="about-course mb-30">
                                            ...
                                            <p>Vous souhaitez créer vos propres sites web ? Vous êtes au bon endroit ! Dans ce cours, vous apprendrez comment utiliser HTML5 et CSS3, les deux langages de programmation à la base de tous les sites web.
...
Alors prêt à réaliser un site web de A à Z ?</p>
                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="single-instructor d-flex align-items-center mb-30">
                                                        <div class="instructor-thumb">
                                                            <img src="img/bg-img/sandy.jpg" alt="">
                                                        </div>
                                                        <div class="instructor-info">
                                                            <h5>Sandly Estalien</h5>
                                    ...
                                    <div class="clever-curriculum">
                                        ...
                                        <div class="about-curriculum mb-30">
                                            ...
                                            <p>Objectifs pédagogiques :<br>
                                                ...
                                                Utiliser du code HTML<br>

                                                Structurer une page web en HTML

                                                Utiliser du code CSS<br>

                                                Mettre en forme une page web en CSS<br>

                                                Organiser les éléments d’une page Web grâce au CSS<br>

                                                Modifier l'agencement d'une page HTML avec CSS<br>

                                                Intégrer des formules dans une page web<br>

                                                Adapter une page pour les petites résolutions en CSS</p>
                                        </div>
                                        ...
                                        <div class="curriculum-level mb-30">
                                            ...
                                            <h5>Introduction</h5>
                                            <p>Decouvrez les Bases D'HTML</p>

                                            <ul class="curriculum-list">
                                                <li><i class="fa fa-file" aria-hidden="true"></i> 1.fonction Des sites Web
                                                    <ul>
                                                        <li>
                                                            <span><i class="fa fa-video-camera" aria-hidden="true"></i> Video: <span>2.Creez votre Prmiere page Web en Html</span></span><br>
                                                            <span><i class="fa fa-video-camera" aria-hidden="true"></i> Video: <span>3.Organisez Votre texte</span></span><br>
                                                            <span><i class="fa fa-video-camera" aria-hidden="true"></i> Video: <span>4.pratiquez</span></span><br>
                                                            <span><i class="fa fa-video-camera" aria-hidden="true"></i> Video: <span>5.Creez des liens</span></span><br>
                                                            <span><i class="fa fa-video-camera" aria-hidden="true"></i> Video: <span>6.Inserez des images</span></span>
                ...
                <div class="col-12 col-lg-4">
                    <div class="course-sidebar">
                        <!-- Buy Course -->
                        <a href="checkout.php" class="btn clever-btn mb-30 w-100">Achetez ce cours</a>
        ...
        <center>
            <button class="btn btn-primary btn-lg text-white">
              <a href="checkout.php">Achetez Ce Cours</a>
            </button>
        </center>
    </div>
        </div>
