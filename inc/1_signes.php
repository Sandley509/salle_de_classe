<?php include('nav.php') ?>
    ...
    <div class="breadcumb-area">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Formation &amp; Professionel</a></li>
                <li class="breadcrumb-item active" aria-current="page">Languages des Signes</li>
            </ol>
        </nav>
    </div>
    <!-- ##### Breadcumb Area End ##### -->
    ...
    <div class="single-course-intro d-flex align-items-center justify-content-center" style="background-image: url(../img/bg-img/signes.jpg);">
        <!-- Content -->
        <div class="single-course-intro-content text-center">
            ...
            <h3>Languages des Signes</h3>
            <div class="meta d-flex align-items-center justify-content-center">
                <a href="#">Pierre Hedruche</a>
                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                <a href="#">Langues &amp; Des signes</a>
            </div>
    ...
    <div class="single-course-content section-padding-100">
            ...
            <div class="row">
                    ...
                    <div class="course--content">
                        ...
                        <div class="clever-tabs-content">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab--2" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="true">Certificat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab--3" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="true">Revision</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab--4" data-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="true">Membre</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab--1">
                                    <div class="clever-description">
                                        ...
                                        <div class="about-course mb-30">
                                            <h4>Apropos de ce cours</h4>
                                            <p>Apprenez La Langues des signes avec le Professeeur Hedruche Pierre description Video et Illustrer diviser
                                            en plusieurs module tres facile...</p>
                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="single-instructor d-flex align-items-center mb-30">
                                                        ...
                                                        <div class="instructor-info">
                                                            <h5>Hedruche Pierre </h5>
                                                            <span> Le Professeur</span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="clever-faqs">
                                            ...
                                            <div class="accordions" id="accordion" role="tablist" aria-multiselectable="true">
                                                ...
                                                <div class="panel single-accordion">
                                                    <h6><a role="button" class="" aria-expanded="true" aria-controls="collapseOne" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Pourrais je m'inscrire dans ce cours Specifique? Je ne suis pas interresser dans une specialisation?
                                                    <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                    <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                    </a></h6>
                                                    <div id="collapseOne" class="accordion-content collapse show">
                                                        <p>Biensur que oui Vous Pouvez par exemple dans le carriere Devloppeur Web Vous pouvez Prendre un language particulier.</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel single-accordion">
                                                    <h6>
                                                        <a role="button" class="collapsed" aria-expanded="true" aria-controls="collapseTwo" data-parent="#accordion" data-toggle="collapse" href="#collapseTwo">Est ce qu ce cours est certifier?
                                                        <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                        <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                        </a>
                                                    </h6>
                                                    <div id="collapseTwo" class="accordion-content collapse">
                                                        <p>Biensur a la fin de cours vous aurez un certificat qui approuveras que vous avez valider ce cours avec Succes.</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel single-accordion">
                                                    <h6>
                                                        <a role="button" aria-expanded="true" aria-controls="collapseThree" class="collapsed" data-parent="#accordion" data-toggle="collapse" href="#collapseThree">Pourrais je suivre ce cours sans aucun prealable?
                                                        <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                        <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                        </a>
                                                    </h6>
                                                    <div id="collapseThree" class="accordion-content collapse">
                                                        <p>Ce cours est entierement pour les debutants et il ne necessite aucun prealables</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel single-accordion">
                                                    <h6>
                                                        <a role="button" aria-expanded="true" aria-controls="collapseFour" class="collapsed" data-parent="#accordion" data-toggle="collapse" href="#collapseFour">Que dois je faire pour obtenir mon Certificat?
                                                        <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                        <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                        </a>
                                                    </h6>
                                                    <div id="collapseFour" class="accordion-content collapse">
                                                        <p>C'est assez simple si vous avez reussis tout les exams a la fin de ce cours dans l'espace continur vous aurez un bouton qui vous
                                                        permettra d'acceder a votre certificats</p>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="course-sidebar">
                        <!-- Buy Course -->
                        <a href="#" class="btn clever-btn mb-30 w-100">Achetez ce cours</a>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <ul class="features-list">
                                ...
                                <li>
                                    <h6><i class="fa fa-thumbs-up" aria-hidden="true"></i>Pourcentage de reussite 80%</h6>
                                    <h6>60</h6>
                                </li>
                                <li>
                                    <h6><i class="fa fa-thumbs-down" aria-hidden="true"></i>Reprise 2</h6>
                                    <h6>5</h6>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="sidebar-widget">
                            <h4>Certification</h4>
                            <img src="../img/bg-img/cer.JPG" alt="">
                        </div>

                        <!-- Widget -->
                        <div class="sidebar-widget">
                            <h4>Vous devriez aimez aussi</h4>
        ...
        <center>
            <button class="btn btn-primary btn-lg">
              <a href="1_signes_cours.php">Commencer</a>
            </button>
        </center>
    </div>
        </div>
