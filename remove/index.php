            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    ...
                    <div class="hero-content text-center">
                        <h2>Etudions Ensemble des aujourd'hui</h2>
                        <a href="#" class="btn clever-btn">Commencer</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Cours en ligne les plus populaires</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="forms">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button class="btn clever-btn w-100">Envoyer un Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="events-thumb">
                            ...
                            <h6 class="event-date">Aout 7</h6>
                            <h4 class="event-title">jour d'ouverture</h4>
                        </div>
                        <!-- Date & Fee -->
                        <div class="date-fee d-flex justify-content-between">
                            <div class="date">
                                <p><i class="fa fa-clock"></i> Aout 7 @ 9:00 am</p>
                            </div>
                            <div class="events-fee">
                                <a href="#" class="free">gratuit</a>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="750ms">
                        ...
                        <div class="events-thumb">
                            ...
                            <h6 class="event-date">Aout 3</h6>
                            <h4 class="event-title">Intervenant</h4>
                        </div>
                        <!-- Date & Fee -->
                        <div class="date-fee d-flex justify-content-between">
                            <div class="date">
                                <p><i class="fa fa-clock"></i> Aout 3 @ 9:00 am</p>
                            </div>
                            <div class="events-fee">
                                <a href="#">$45</a>
                            </div>
